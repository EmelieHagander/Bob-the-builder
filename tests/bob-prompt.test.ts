...
test('server safeguards remain separate from the persona and old voice overrides are removed', () => {
  ...
  assert.match(BOB_TRUTH_RULES, /do NOT reconstruct or manually copy it into propose_project_plan/)
  ...
  assert.match(BOB_TRUTH_RULES, /A blocked review or missing_context on the save bridge is not a permission refusal/)

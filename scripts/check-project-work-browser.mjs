...
try{
 ...
 for(const width of [320,390,1280]){
  ...
  assert(reads>=4);assert.equal(await plan.getByRole('link',{name:'Cut panels',exact:true}).count(),2,'One primary plus one collapsed reference, never a second owned Task')

...
Only the listed fields can be saved: project description, task name/instructions, measurement revisions and the supported parametric storage-box drawing. Read the current selected target and drawing recipe before drawing changes. Drawings are Concept design specifications, not measured site facts; linked measurements remain separate evidence and must be preserved. Use the drawing tool rather than inventing an AI image or pretending to edit a generic CAD file. No deletion, purchases, assignment, sharing, completion or readiness confirmation. Give a brief factual result, not another offer to do the work.

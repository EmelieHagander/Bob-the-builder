...
import { DELIVERY_LANGUAGE_SCHEMA, DELIVERY_LANGUAGE_INSTRUCTION, parseDeliveryLanguage, type DeliveryLexicon } from './delivery-language.ts'
...
export interface WorkIntent { goals: WorkGoal[]; request_quote: string | null; delivery_language?:DeliveryLexicon }
export const WORK_INTENT_SCHEMA = { type:'object', additionalProperties:false, properties:{
  ...
  delivery_language:DELIVERY_LANGUAGE_SCHEMA,
},required:['goals','request_quote','delivery_language']}

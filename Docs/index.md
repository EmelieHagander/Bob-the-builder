...
| generic construction geometry and real CAD-engine adapter | `Docs/cad-adapter.md` — build123d/OpenCascade adapter foundation; implementation branch, not deployed |
...
- `Docs/cad-adapter.md` — **slice B adapter foundation, not deployed**: Bob-owned mm construction contract, strict build123d/OpenCascade translation, STEP/SVG output and internal worker boundary. It is not yet persisted generic assembly state or a complete drawing/BOM pipeline.
